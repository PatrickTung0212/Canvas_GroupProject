...
Getting Started
Launch the Canvas Application on your device.
Familiarize yourself with the toolbar located at the top of the application's interface. This toolbar contains all the tools and options you need to create your artwork.
Drawing Tools
...
Upload Image: Import an existing image by clicking on the upload button. Select the desired image file from your device.
Filter Effects
Add artistic flair to your creations with filter effects. Experiment with different effects by selecting them from the toolbar.

Conclusion
With these instructions, you are now ready to unleash your creativity using the Canvas Application. Enjoy exploring the various tools, customization options, and features!